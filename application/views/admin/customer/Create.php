  ...
  ?>
        <div class="row">
          ...
          <div class="card card-warning">
              ...
              <!-- /.card-header -->
              <!-- form start -->
              <form action="<?php echo base_url('admin/Customers/create'); ?>" method="post" name="add_admin" id="add_admin">
                <div class="card-body">
                <div class="form-group">
                  ...
                  <div class="form-group">
                    ...
                    placeholder="Enter CNIC"  value="<?php echo set_value('cnic');?>">
                    <div class="text-danger"> <?php echo form_error('cnic');?></div>
                </div>
                <div class="form-group">
                    <label for="cityid">City</label>
                    <input type="text" class="form-control" name="city" 
                    id="cityid" placeholder="City"  value="<?php echo set_value('city');?>">
